...
const MUDANCAS = [
  {
    icon: GitBranch,
    title: "Mesma versão para os dois lados",
    body: [
      "O cliente corporativo abre o <strong class=\"font-semibold text-gray-900\">mesmo contrato</strong> que você está editando. Comentários ficam onde a discussão acontece.",
      "Quando alguém precisa lembrar o que foi combinado, não existe mais versão A contra versão B."
    ],
    closer: "Mesma versão. Dois lados.",
    visual: "versao"
  },
  {
    icon: UserPlus,
    title: "Advogado externo trabalha dentro do contrato, não em volta dele",
    body: [
      "Você convida o <strong class=\"font-semibold text-gray-900\">advogado externo</strong> direto para o contrato. Ele revisa dentro do ambiente, sem você precisar exportar PDF e esperar resposta no e-mail.",
      "O acesso de visitante é gratuito permanente."
    ],
    closer: "O advogado entra. Não exporta.",
    visual: "advogado"
  },
  {
    icon: Shield,
    ...
    body: [
      "Se o contrato vira disputa, a <strong class=\"font-semibold text-gray-900\">câmara SOMA</strong> está acoplada. Mediação confidencial, sem expor a relação publicamente.",
      "Resolução privada, do mesmo ambiente, sem fila judicial e sem queimar o cliente."
    ],
    closer: "Resolução privada por padrão.",
    visual: "soma"
  }
];

// Day 0 → 30 → 90 do onboarding para PME
const RAMP = [
  {
    when: "Dia 0",
  ...
  {
    when: "Dia 30",
    title: "Próximo contrato negociado de ponta a ponta",
    body: "O próximo contrato com cliente corporativo é negociado direto na +legal_. O cliente entra como editor, seu advogado revisa por dentro, e o histórico fica registrado desde o rascunho."
  },
  {
    when: "Dia 90",
    title: "Drive virou backup",
    body: "Os contratos vivos vivem na +legal_. O Drive ficou só como backup. Quando alguém pergunta o que foi combinado, a resposta está a um clique, não em um e-mail de 2024."
  }
];
...
const PORQUE_AGORA = [
  {
    ...
    body: "A equipe da +legal_ importa os primeiros contratos com você, ajusta os campos do seu negócio, e cadastra seu advogado externo como <strong class=\"font-semibold text-gray-900\">visitante gratuito permanente</strong>."
  },
  {
    icon: Calendar,
    title: "Operador gratuito permanente",
    body: "Você como operador continua gratuito mesmo depois do lançamento público. O preço de lançamento dos próximos operadores fica garantido para os primeiros workspaces."
  },
  {
    icon: MessageSquare,
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-stone-200 bg-white">
        <HeroLogoBg position="top-right" color="var(--peach-dark)" opacity={0.07} width={560} />
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[1.1fr_1fr]">
            <div>
              <div
                ...
                style={{ background: "var(--peach-bg)", borderColor: "rgba(30,41,59,0.4)" }}
              >
                <span className="font-mono text-[11px] font-bold uppercase tracking-widest text-slate-800">
                  Para você que fecha contrato com cliente corporativo.
                </span>
              </div>

              <h1 className="mb-6 font-title text-4xl font-bold tracking-tighter text-gray-900 md:text-5xl lg:text-[52px] leading-[1.06]">
                Você fechou um negócio importante. Agora o contrato precisa viver no mesmo lugar para os dois lados.
              </h1>

              <p className="mb-3 text-lg leading-relaxed text-gray-700 md:text-xl">
                A +legal_ é o ambiente onde você, o cliente corporativo, e seu advogado externo trabalham na mesma versão do contrato.
              </p>
              <p className="mb-8 text-lg leading-relaxed text-gray-700 md:text-xl">
                <strong className="font-semibold text-gray-900">Sem exportar PDF. Sem perder o histórico no e-mail.</strong>
              </p>
              ...
              <div className="flex flex-wrap gap-3">
                <Button
                  ...
                  variant="primary"
                  size="lg"
                  className="!bg-slate-800 !border-slate-800 hover:!bg-slate-800/90"
                >
      ...
      <section className="bg-stone-50">
        <div className="container-soma section-soma">
          <div className="mb-12 max-w-[820px]">
            <p className="eyebrow mb-3 text-slate-800">O que muda no dia a dia</p>
            <h2 className="h-soma mb-4">
              Três coisas passam a viver no mesmo lugar para os dois lados.
            </h2>
            <p className="text-lg leading-relaxed text-gray-600">
              A versão do contrato, o advogado externo que revisa, e a resolução se um dia travar. Tudo dentro do mesmo ambiente, em vez de espalhado entre seu e-mail, o Drive do cliente, e o PDF do advogado.
            </p>
          </div>
              ...
              return (
                ...
                >
                  <div className={reverse ? "lg:order-2" : ""}>
                    ...
                    >
                      <Icon className="size-5 text-slate-800" strokeWidth={1.6} />
                    </div>
      ...
      <section className="bg-white">
        <div className="container-soma section-soma">
          <div className="mb-12 max-w-[820px]">
            <p className="eyebrow mb-3 text-slate-800">Como começa</p>
            <h2 className="h-soma mb-4">
              Do primeiro contrato importado até o Drive virar backup.
            </h2>
            <p className="text-lg leading-relaxed text-gray-600">
              Você não precisa virar especialista em mais uma ferramenta. A equipe acompanha os primeiros passos, e em 90 dias o ambiente já é onde a conversa de contrato acontece.
            </p>
          </div>
            ...
            {RAMP.map((step, i) => (
              ...
              >
                <div className="mb-5 flex items-center gap-3">
                  ...
                  <p className="font-mono text-[11px] font-bold uppercase tracking-widest text-slate-800">
                    {step.when}
                  </p>
                </div>
      ...
      <section className="bg-stone-50">
        <div className="container-soma section-soma">
          <div className="mb-12 max-w-[820px]">
            <p className="eyebrow mb-3 text-slate-800">Por que entrar agora</p>
            <h2 className="h-soma mb-4">
              Os primeiros workspaces moldam a +legal_.
            </h2>
            <p className="text-lg leading-relaxed text-gray-600">
              O Early Access para PMEs é mais que acesso antecipado. Quem entra agora ganha onboarding personalizado, advogado externo gratuito permanente, e canal direto com os fundadores.
            </p>
          </div>
        ...
        <div className="container-soma py-16 md:py-20">
          <div className="mx-auto max-w-[860px] text-center">
            ...
            <h2 className="mb-6 font-title text-3xl font-bold tracking-tighter md:text-4xl lg:text-5xl">
              Você fecha o próximo contrato dentro da +legal_. Ou conversa primeiro com a equipe.
            </h2>
            <p className="mx-auto mb-10 max-w-[640px] text-lg leading-relaxed text-white/80">
              O caminho rápido é entrar para o Early Access e começar a importar com a equipe acompanhando. O cauteloso é uma conversa de 30 minutos antes de decidir.
            </p>
  ...
  return (
    <div className="relative">
      ...
      <svg
        ...
        {/* Header do contrato */}
        <rect x="0" y="32" width="600" height="64" fill="#F8FAFC" />
        ...
        <g transform="translate(24 180)">
          ...
          <rect x="0" y="40" width="430" height="36" rx="4" fill="#F1F5F9" stroke="var(--peach-dark)" strokeWidth="1.2" />
...
// Mudança 1 · Mesma versão para todos
  ...
  return (
    <svg viewBox="0 0 480 280" xmlns="http://www.w3.org/2000/svg" className="h-auto w-full"aria-hidden="true">
      ...
      <g transform="translate(260 20)">
        ...
        {/* Documento único */}
        <rect x="14" y="24" width="172" height="44" rx="4" fill="#F1F5F9" stroke="var(--peach-dark)" strokeWidth="1" />
      ...
      <text x="240" y="246" fontFamily="JetBrains Mono, monospace" fontSize="9" fontWeight="700" fill="#666" textAnchor="middle" letterSpacing="1.5">
        VERSÃO A E VERSÃO B DEIXAM DE EXISTIR
      </text>
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 480 280" xmlns="http://www.w3.org/2000/svg" className="h-auto w-full"aria-hidden="true">
      ...
      <g transform="translate(20 218)">
        <rect width="440" height="40" rx="6" fill="#F8FAFC" stroke="rgba(30,41,59,0.3)" strokeWidth="1" />
