      ...
      <div className="container-soma section-soma relative">
        <div className="mb-12 max-w-[820px]">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-brand/20 bg-brand-tint px-3 py-1.5">
            <Monitor className="size-4 text-brand" strokeWidth={1.6} />
            <span className="font-mono text-[11px] font-bold uppercase tracking-widest text-brand">
              A plataforma
            </span>
          </div>
          <h2 className="h-soma mb-4">O portfólio inteiro em um lugar só.</h2>
          <p className="mb-3 text-lg leading-relaxed text-gray-600">
            Você acompanha o status de cada contrato, vê os alertas de renovação que estão chegando, e identifica as obrigações que ainda precisam de atenção.
          </p>
          <p className="text-lg leading-relaxed text-gray-600">
            Tudo em um único ambiente, acessível para todos os envolvidos no contrato, em condições iguais de informação.
          </p>
        </div>
                ...
                <div className="flex-1 p-6 md:p-7">
                  ...
                  <div className="mb-5 grid grid-cols-3 gap-3">
                    {[
                      ...
                      <div key={s.label} className="rounded-lg bg-stone-50 p-4">
