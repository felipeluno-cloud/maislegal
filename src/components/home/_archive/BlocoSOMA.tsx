  ...
  return (
    <div className="mx-auto max-w-[1100px]">
      ...
      >
        ...
        {/* Etapa 03 · Mediação primeiro */}
        <g transform="translate(770 110)">
          <circle r="55" fill="white" stroke="var(--peach-dark)" strokeWidth="2" />
        ...
        <g transform="translate(910 110)">
          ...
          <path d="M -8 0 L 8 0 M 4 -4 L 8 0 L 4 4" stroke="var(--after, #2E8B57)" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
        </g>

        {/* Etapa 04 · Resolvido */}
        <g transform="translate(1010 110)">
          <circle r="55" fill="white" stroke="var(--after, #2E8B57)" strokeWidth="2.5" />
          <path
